...
### gui_gantry_2.4
# ------ Adding sensors
# ----- Adding condition so you have to disconnect the camera before closing
# (otherwise the camera doesn't turn off)
...
class StageGUI2(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Gantry Control w/ Sensors 2.4")
...
# ---- Step / Feed -----
        ...
        self.microscope_page = QWidget()
        microscope_layout = QVBoxLayout(self.microscope_page)
        microscope_layout.addWidget(QLabel("Microscope tab coming soon."))

        self.automation_page = QWidget()
        automation_layout = QVBoxLayout(self.automation_page)
        automation_layout.addWidget(QLabel("Automation tab coming soon."))

        self.pages.addWidget(self.gantry_page)          # index 0
        self.pages.addWidget(self.sensors_tab_widget)   # index 1
        self.pages.addWidget(self.microscope_page)      # index 2
        self.pages.addWidget(self.automation_page)      # index 3
